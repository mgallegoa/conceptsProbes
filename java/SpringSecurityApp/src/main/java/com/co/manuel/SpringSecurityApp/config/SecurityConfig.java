...
import com.co.manuel.SpringSecurityApp.services.UserDetailsServiceImpl;
...
public class SecurityConfig {
   ...
   * // Secured endpoints.
   * // Use method hasAnyAuthority("READ", "CREATE") to specify list permissions
   * // Use method hasRole("ADMIN") to validate for roles. hasAnyRole() for list
   * 
  ...
  public AuthenticationProvider authenticationProvider(UserDetailsServiceImpl userDetailsServiceImpl) {
    DaoAuthenticationProvider daoProvider = new DaoAuthenticationProvider(userDetailsServiceImpl);
